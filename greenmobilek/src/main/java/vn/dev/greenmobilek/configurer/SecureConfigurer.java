...
//		.antMatchers("/manager/**").hasAnyAuthority("ADMIN") //CHI ROLE ADMINISTRATOR MOI VAO DUOC CAC TRANG ADMINISTRATOR
		.antMatchers("/manager/**").hasAnyAuthority("ADMIN", "STAFF") //hasAnyAuthority cho phép duyệt nhiều role cùng một lệnh
...
////			$2a$04$CGSp7ZE7B6IBEJlCENxAvOB7FQ6ufQWjE9UX05VV7cUjgLUTf1U5q  $2a$04$ALGsl/UWvXO7ZCPxlqDdIe.LHQqI0js4qrnzqCS46LleMSMMvCyT2

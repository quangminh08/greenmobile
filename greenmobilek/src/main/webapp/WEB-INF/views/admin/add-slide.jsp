...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
        	<sf:form class="form" action="${classpath }/manager/save-add-slide" method="post" modelAttribute="newImage" enctype="multipart/form-data">
				<div class="form-body container">
					...
					<div class="container" style="margin-left: 100px; justify-content: end">
						...
						<div style="margin-top:25px;"  class="row">
							<div class="col-md-12">
								<div class="form-group mb-4">
									<a href="${classpath }/manager/list-slide" class="btn btn-primary active" role="button"
